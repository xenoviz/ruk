...
retains the assignment and prints the exact recovery ID. Use `ruk shell
<branch>` for an interactive assigned shell; commit intended work before exit
so normal release can succeed.
